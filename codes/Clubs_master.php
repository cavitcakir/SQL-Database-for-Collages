...
$check = mysqli_query($link,"SELECT C.Name AS Name, C.President_ID, C.Email, P.Name  AS Student_Name FROM clubs C, Joins J, student S, People P WHERE C.Name = J.Club_Name AND S.ID = J.Student_ID AND S.ID = P.ID");
    ...
    <div class="container-table200">
      <div class="wrap-table200">
          <div class="table">
            ...
            {
              $Name=$myarr[$i]['Name'];
              $Student_Name =$myarr[$i]['Student_Name'];
              ...
              <div class="row">
                ...
                <div class="cell" data-title="Member">
