...
$check = mysqli_query($link,"SELECT * FROM clubs");
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <a class="nav-link" href="Clubs_reg.php">Clubs <span class="sr-only">(Current)</span></a>
          </li>
      ...
      <div class="wrap-table100">
          <div class="table">
            ...
            <div class="row header">
              ...
              <div  class="cell">President ID </div>
            </div>
            ...
            for($i=0;$i<$row_number;$i++)
            {
              $Name=$myarr[$i]['Name'];
              $Mail=$myarr[$i]['Email'];
              $President_ID =$myarr[$i]['President_ID'];
              ...
              <div class="row">
                ...
                <div class="cell" data-title="President_ID">
                  <?php echo "$President_ID " ?>
                </div>
