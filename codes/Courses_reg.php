...
$check = mysqli_query($link,"SELECT CT.Course_Code, CT.Name AS Course_Name, P.Name AS Course_Teacher, CT.Credit, CT.Class, CT.Time, PR.Prequisite_of 
FROM belongs_to B , People P, course_teacher CT  LEFT JOIN prerequisite_of PR ON PR.Course = CT.Course_Code 
WHERE B.Course_Code = CT.Course_Code  AND P.ID = CT.Instructor_Id AND CT.Course_Code <> '-'");
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <a class="nav-link" href="Welcome_Page_reg.html"> Entry Page <span class="sr-only"></span></a>
                </li>
                <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                    <a href="Students_reg.php">Students</a>
                    <a href="Instructor_reg.php">Instructors</a>
                  </div>
                </div>
              </li>
              <a class="nav-link" href="Clubs_reg.php">Clubs <span class="sr-only"></span></a>
              </li>
              <a class="nav-link" href="Courses_reg.php">Courses <span class="sr-only"></span></a>
              </li>
              <div class="dropdown">
                ...
                <div class="dropdown-content">
                  <a href="FENS_reg.php">FENS<span class="sr-only"></span></a>
                  <a href="FASS_reg.php">FASS<span class="sr-only"></span></a>
                  <a href="FMAN_reg.php">FMAN<span class="sr-only"></span></a>
                </div>
              </div>
              </li>
              <a class="nav-link" href="Search_reg.php">ID Search <span class="sr-only"></span></a>
              </li>
      ...
      <div class="wrap-table100">
          <div class="table">
            ...
            <div class="row header">
              <div  class="cell">Course_Code </div>
              <div  class="cell">Course_Name </div>
              <div  class="cell">Course_Teacher </div>
              <div  class="cell">Credit </div>
              <div  class="cell">Class </div>
              <div  class="cell">Time </div>
              <div  class="cell">Prerequisite of </div>
            ...
            {
              $Course_Code=$myarr[$i]['Course_Code'];
              $CourseName=$myarr[$i]['Course_Name'];
              $Course_Teacher =$myarr[$i]['Course_Teacher'];
              $Credit=$myarr[$i]['Credit'];
              $Class=$myarr[$i]['Class'];
              $Time =$myarr[$i]['Time'];
              $Prerequisite_of =$myarr[$i]['Prequisite_of'];


              ?>

              <div class="row">
                <div class="cell" data-title="Course_Code">
                  <?php echo "$Course_Code " ?>
                </div>
                <div class="cell" data-title="Course_Name">
                  <?php echo "$CourseName " ?>
                </div>
                <div class="cell" data-title="Course_Teacher">
                  <?php echo "$Course_Teacher " ?>
                </div>
                <div class="cell" data-title="Credit">
                  <?php echo "$Credit " ?>
                </div>
                ...
                <div class="cell" data-title="Time">
                 ...
                 <div class="cell" data-title="Prerequisite_of">
                  <?php echo "$Prerequisite_of " ?>
                </div>
              </div>
