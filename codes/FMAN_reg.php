...
<html>
  ...
  $check = mysqli_query($link,"SELECT CT.Course_Code, CT.Name AS Course_Name, P.Name AS Course_Teacher, CT.Credit, CT.Class, CT.Time FROM belongs_to B, course_teacher CT , People P WHERE B.Course_Code = CT.Course_Code  AND P.ID = CT.Instructor_Id AND B.Faculty = 'FMAN'");
