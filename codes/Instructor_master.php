...
$check = mysqli_query($link,"SELECT O.Phone_Number, P.Name AS Name, I.ID, I.Office_Number, I.Contract_id 
FROM Instructor I , People P, OFFICE O 
WHERE P.ID = I.ID AND I.Office_Number = O.Office_Number AND I.ID <> 0");
