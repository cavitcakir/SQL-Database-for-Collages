...
$check = mysqli_query($link,"SELECT O.Phone_Number, P.Name AS Name, I.ID, I.Office_Number, I.Contract_id, W.Faculty 
FROM Instructor I, Works_In W , People P, OFFICE O 
WHERE W.Instructor_ID = I.ID AND P.ID = I.ID AND I.Office_Number = O.Office_Number AND I.ID <> 0");
      ...
      <div class="wrap-table100">
          <div class="table">
            ...
            <div class="row header">
              ...
              <div  class="cell">Contract ID</div>
              <div  class="cell">Office Number </div>
            ...
            {
              $Faculty=$myarr[$i]['Faculty'];
              $Name=$myarr[$i]['Name'];
              $ID =$myarr[$i]['ID'];
              $Office_Number=$myarr[$i]['Office_Number'];
              $Contract_id=$myarr[$i]['Contract_id'];
              $Phone_Number =$myarr[$i]['Phone_Number'];
              ...
              <div class="row">
                ...
                <div class="cell" data-title="Contract_id">
                  <?php echo "$Contract_id " ?>
                </div>
                <div class="cell" data-title="Office_Number">
                  <?php echo "$Office_Number " ?>
                </div>
                <div class="cell" data-title="Phone_Number">
