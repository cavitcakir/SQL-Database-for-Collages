...
<!DOCTYPE html>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <a class="nav-link" href="Search_reg.php">ID Search <span class="sr-only">(Current)</span></a>
          </li>
...
if(isset($_POST['search']))
{
  ...
  $query = "SELECT * FROM People WHERE CONCAT(`Name`, `Mail`, `ID`, `Sex`) LIKE '%".$valueToSearch."%'";
...
{
  $connect = mysqli_connect("localhost", "root", "", "course_database_bcnf");
  ...
  <body>
    ...
    <form align="center" action = "search.php" method="post">
      ...
      <table class="table table-striped table-hover table-responsive" id="myTable">
        ...
        <tr style="text-align: center; background-color : DeepPink ">
