    ...
    */
    ...
    $check = mysqli_query($link,"SELECT P.Name, S.ID,S.Major, S.Entrance_Year, S.Total_Credit, s_in.Faculty 
    FROM People P, student S LEFT JOIN studies_in s_in ON S.ID=s_in.Student_ID 
    WHERE P.ID = S.ID ");
