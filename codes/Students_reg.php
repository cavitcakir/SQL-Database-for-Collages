...
$check = mysqli_query($link,"SELECT P.Name, S.ID,S.Major, S.Entrance_Year, S.Total_Credit, studies_in.Faculty FROM student S, studies_in , People P WHERE P.ID = S.ID AND S.ID=studies_in.Student_ID");
          ...
          <div class="wrap-table100">
              <div class="table">
                ...
                <div class="row header">
                  ...
                  <div  class="cell"> Name </div>
                       <div  class="cell"> Major </div>
                        <div  class="cell"> Entrance_Year</div>
                        <div  class="cell">Total_Credit </div>
                ...
                for($i=0;$i<$row_number;$i++)
                {
                 ...
                 $Name=$myarr[$i]['Name'];
              $Major=$myarr[$i]['Major'];
              $Entrance_Year =$myarr[$i]['Entrance_Year'];
              $Total_Credit=$myarr[$i]['Total_Credit'];
              $Faculty=$myarr[$i]['Faculty'];
                  ...
                  <div class="row">
                    ...
                    <div class="cell" data-title="Major">
                                      <?php echo "$Major " ?>

                    </div>
                    <div class="cell" data-title="Entrance_Year">
                                      <?php echo "$Entrance_Year " ?>

                    </div>
                    <div class="cell" data-title="Total_Credit">
